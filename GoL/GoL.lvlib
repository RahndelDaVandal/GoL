...
<Library LVVersion="26008000">
	...
	<Item Name="[BOOL] to [U8].vi" Type="VI" URL="../[BOOL] to [U8].vi"/>
	<Item Name="[U8] to [BOOL].vi" Type="VI" URL="../[U8] to [BOOL].vi"/>
	<Item Name="GoL.lvclass" Type="LVClass" URL="../GoL/GoL.lvclass"/>
</Library>
